...
import com.petHis.common.utils.CookieUtils;
...
import com.petHis.project.system.menu.domain.Menu;
...
public class IndexController extends BaseController
{
    ...
    @Autowired
    private PetHisConfig petHisConfig;
    ...
    public String index(ModelMap mmap)
    {
        ...
        mmap.put("copyrightYear", petHisConfig.getCopyrightYear());
        mmap.put("demoEnabled", petHisConfig.isDemoEnabled());
    ...
    {
        mmap.put("version", petHisConfig.getVersion());
