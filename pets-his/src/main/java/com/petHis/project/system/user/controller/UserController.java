...
import com.petHis.common.utils.security.AuthorizationUtils;
...
import com.petHis.project.system.post.service.IPostService;
...
public class UserController extends BaseController
{
    ...
    @ResponseBody
    public TableDataInfo selectUserByRole(User user){
        System.out.println("--------------------listByRole");
        System.out.println(user);
        System.out.println("---------------------");
        System.out.println(user.getRoleKey());
//        return userService.selectUserByRole(user.getRoleKey());

        startPage();
        List<User> list = userService.selectUserByRole(user.getRoleKey());
        return getDataTable(list);
    }
